...
export const metadata: Metadata = {
  ...
  description: '150.000 open vacatures, 1 man op leeftijd, 1 intentie, 0 pretenties. Live documentatie van een 55+ professional in het wervingsproces van Defensie.',
  ...
  openGraph: {
    ...
    description: '150.000 open vacatures, 1 man op leeftijd, 1 intentie, 0 pretenties.',
    type: 'website',
    locale: 'nl_NL',
  },
}
